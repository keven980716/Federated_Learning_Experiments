class MyMessage(object):
    ...
    MSG_ARG_KEY_ALPHA = "alpha"
    MSG_ARG_KEY_PROTOTYPES = "prototypes"
    MSG_ARG_KEY_BALANCED_GRADS = "balanced_gradients"
    MSG_ARG_KEY_BA_PARAMS = "ba_params"
    MSG_ARG_KEY_CREFF_RETRAINED_PARAMS = "creff_retrained_params"
