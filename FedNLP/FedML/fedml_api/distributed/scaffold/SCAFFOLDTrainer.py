...
class SCAFFOLDTrainer(object):
    ...
    def train(self, round_idx=None, global_control_variate=0, local_control_variate=0):
        if round_idx is not None:
            self.args.round_idx = round_idx
        local_control_variate = self.trainer.train(self.train_local, self.device, self.args, global_control_variate,
        ...
        return weights, self.local_sample_number, local_control_variate
