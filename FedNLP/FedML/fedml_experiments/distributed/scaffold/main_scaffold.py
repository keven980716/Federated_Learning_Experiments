...
from fedml_api.data_preprocessing.MNIST.data_loader_new import load_partition_data_mnist
...
from fedml_api.distributed.scaffold.SCAFFOLDAPI import FedML_init, FedML_SCAFFOLD_distributed
...
def add_args(parser):
    ...
    """
    # Training settings
    parser.add_argument('--fl_algorithm', type=str, default="SCAFFOLD",
                        help='SCAFFOLD')
...
if __name__ == "__main__":
    ...
    str_process_name = "SCAFFOLD (distributed):" + str(process_id)
    ...
    if process_id == 0:
        wandb.init(
            ...
            project="fedml_cifar10",
            entity='keven9816',
            name="SCAFFOLD(d)" + " partition=" + args.partition_method + " alpha=" + str(args.partition_alpha) + " S_LR=" + str(args.server_lr) +
    ...
    FedML_SCAFFOLD_distributed(process_id, worker_number, device, comm,
