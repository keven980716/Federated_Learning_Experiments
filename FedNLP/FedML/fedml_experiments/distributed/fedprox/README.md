...
(4) **--client_sampling_strategy**: the choice of the client sampling strategy, can be chosen from {'uniform', 'MD', 'AdaFL'} (**not available for FedProx now, but can be easily adopted from the code for FedAvg**).
...
```bash
CUDA_VISIBLE_DEVICES=0,1 sh run_fedprox_distributed_pytorch.sh 100 10 resnet56 hetero 200 20 64 0.1 cifar10 "./../../../data/cifar10" sgd 0 0.5
```
