...
mpirun -np $PROCESS_NUM -hostfile ./mpi_host_file python3 ./main_fedprox.py \
  ...
  --fedprox_mu 1.0 --lr_bound_factor 0.02 --client_sampling_strategy uniform

# sh run_fedprox_distributed_pytorch.sh 100 10 resnet56 hetero 200 20 64 0.1 cifar10 "./../../../data/cifar10" sgd 0 1.0
