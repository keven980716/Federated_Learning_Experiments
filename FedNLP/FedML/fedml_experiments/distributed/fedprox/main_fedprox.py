...
from fedml_api.distributed.fedprox.FedProxAPI import FedML_init, FedML_FedProx_distributed
...
if __name__ == "__main__":
    ...
    str_process_name = "FedProx (distributed):" + str(process_id)
    ...
    if process_id == 0:
        wandb.init(
            ...
            name="FedProx(d)" + " partition=" + args.partition_method + " alpha=" + str(args.partition_alpha) + " S_LR=" + str(args.server_lr) +
                   " C_LR=" + str(args.lr) + " C_OPT=" + str(args.client_optimizer) + " C_MOM=" + str(args.client_momentum) +
                   " local_epochs=" + str(args.epochs) + " fedprox_mu=" + str(args.fedprox_mu) +
    ...
    FedML_FedProx_distributed(process_id, worker_number, device, comm,
