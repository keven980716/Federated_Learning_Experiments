...
def add_args(parser):
    ...
    parser.add_argument('--client_momentum', type=float, default=0.0,
...
if __name__ == "__main__":
    ...
    if process_id == 0:
        wandb.init(
            ...
            project="fedml",
            entity='keven9816',
            name="FedOPT(d)" + " partition=" + args.partition_method + " alpha=" + str(args.partition_alpha) + " S_LR=" + str(args.server_lr) +
