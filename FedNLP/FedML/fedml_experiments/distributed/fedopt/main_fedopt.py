...
def add_args(parser):
    ...
    """
    # Training settings
    parser.add_argument('--fl_algorithm', type=str, default="FedOPT",
                        help='FedOPT')
...
if __name__ == "__main__":
    ...
    if process_id == 0:
        wandb.init(
            ...
            name="FedOPT(d)" + " partition=" + args.partition_method + " alpha=" + str(args.partition_alpha) + " S_OPT=" + str(args.server_optimizer) +
                 " S_LR=" + str(args.server_lr) + " S_MOM=" + str(args.server_momentum) + " C_OPT=" + str(args.client_optimizer) + " C_LR=" + str(args.lr) +
